 ...
 * 
 */
@WebServiceClient(name = "SayHelloImplService", targetNamespace = "http://shaheen.com/", wsdlLocation = "http://localhost:8088/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SAYHELLOIMPLSERVICE_QNAME = new QName("http://shaheen.com/", "SayHelloImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8088/hello?wsdl");
    ...
    public SayHelloImpl getSayHelloImplPort() {
        return super.getPort(new QName("http://shaheen.com/", "SayHelloImplPort"), SayHelloImpl.class);
    }
    ...
    public SayHelloImpl getSayHelloImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://shaheen.com/", "SayHelloImplPort"), SayHelloImpl.class, features);
    }
