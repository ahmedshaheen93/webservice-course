 ...
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://shaheen.com/", wsdlLocation = "http://localhost:8080/calculator/calc?wsdl")
public class CalculatorService
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://shaheen.com/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/calculator/calc?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://shaheen.com/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://shaheen.com/", "CalculatorPort"), Calculator.class, features);
    }
