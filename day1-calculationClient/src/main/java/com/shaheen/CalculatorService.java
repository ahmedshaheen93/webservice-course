 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://shaheen.com/", wsdlLocation = "http://localhost:8088/calc?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8088/calc?wsdl");
