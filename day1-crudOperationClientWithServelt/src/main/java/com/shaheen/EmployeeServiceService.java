 ...
 */
@WebServiceClient(name = "EmployeeServiceService", targetNamespace = "http://shaheen.com/", wsdlLocation = "http://localhost:8080/Employee/employee?wsdl")
public class EmployeeServiceService
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/Employee/employee?wsdl");
